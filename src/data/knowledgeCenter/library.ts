...
export const libraryItems: LibraryItem[] = [
  ...
  },
  {
    ...
    description: "Security patterns and controls for digital business platforms",
    contentType: "Technical Specification",
    format: "PDF",
    typeIcon: "Shield",
    author: "Security Architecture Team",
    length: "Comprehensive (38 pages)",
    datePublished: "February 2024",
    topics: ["Security", "Architecture Patterns"],
    audience: "Architect"
  },
  {
    id: "executive-transformation-briefing",
    title: "Executive Transformation Briefing Pack",
    description: "Executive-level overview of digital transformation fundamentals",
    contentType: "White Paper",
    format: "PPTX",
    typeIcon: "Presentation",
    author: "Transformation Office",
    length: "Quick Read (15 slides)",
    datePublished: "January 2024",
    topics: ["DBP Framework", "4D Model"],
    audience: "Executive"
  },
  {
    id: "integration-patterns-catalog",
    title: "Enterprise Integration Patterns Catalog",
    description: "Comprehensive catalog of integration patterns for digital platforms",
    contentType: "Technical Specification",
    format: "PDF",
    typeIcon: "Code",
    author: "Integration Team",
    length: "Comprehensive (65 pages)",
    datePublished: "December 2023",
    topics: ["Integration", "Architecture Patterns"],
    audience: "Architect"
  },
  {
    id: "customer-experience-metrics",
    title: "Customer Experience Metrics Framework",
    description: "Framework for measuring and improving customer experience",
    contentType: "Framework Guide",
    format: "PDF",
    typeIcon: "BarChart3",
    author: "CX Team",
  ...
  },
  {
    ...
    title: "DevOps Maturity Assessment Model",
    description: "Model for assessing and improving DevOps capabilities",
    contentType: "Framework Guide",
    format: "PDF",
    typeIcon: "BarChart3",
    author: "DevOps Team",
    ...
    datePublished: "November 2023",
    topics: ["DevOps", "Maturity Assessment"],
    audience: "Practitioner"
  },
  {
